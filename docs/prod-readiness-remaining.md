...
- `app.json` (H3): while `MESH_PARKED`, strip the mesh permissions / connectedDevice FGS / `REQUEST_IGNORE_BATTERY_OPTIMIZATIONS` (Play-review friction). Needs a config-plugin switch.
