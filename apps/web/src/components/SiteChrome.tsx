    ...
    <footer className="border-t border-neutral-200 bg-white">
      <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-12 md:gap-6">
        <div>
          ...
          {/* Social profiles. Icon-only links, so each carries an aria-label.
              Icons inherit currentColor and share the same neutral hover as the
              text links above. */}
...
// Feather-style monoline glyphs — consistent stroke weight with the minimal
// footer, and they draw with currentColor so hover states just work.
